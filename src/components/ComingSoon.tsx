  ...
  return (
    <div className="h-full w-full rounded-none bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <input
          type="text"
          placeholder="you@orgnisation.com"
          className="rounded-lg border text-lg p-2 text-neutral-50 border-neutral-800 focus:ring-2 focus:ring-teal-500  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-400"
        />
      </div>
      <BackgroundBeams />
    </div>
